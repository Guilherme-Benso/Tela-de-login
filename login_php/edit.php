        ...
        <div class="box">
            <form action="save.php" method="POST">
                <fieldset>
                    ...
                    <p>Sexo:</p>
                    <div class="radio">
                        <input type="radio" name="genero" id="feminino" value="feminino" class="radio" <?php echo ($genero == "feminino") ? "checked" : " " ?> required>
                        <label for="feminino">Feminino</label>
                        <br>
                        <input type="radio" name="genero" id="masculino" value="masculino" class="radio" <?php echo ($genero == "masculino") ? "checked" : " " ?> required>
                        <label for="masculino">Masculino</label>
                        <br>
                        <input type="radio" name="genero" id="outro" value="outro" class="radio" <?php echo  ($genero == "outro") ? "checked" : " " ?> required>
                    ...
                    <div class="input-data">
                        ...
                        <input type="date" name="data-nascimento" id="data-nascimento" class="input-user" value="<?php echo $data;?>" required>
                    </div>
                    ...
                    <input type="submit" value="Enviar" id="update" name="update">
